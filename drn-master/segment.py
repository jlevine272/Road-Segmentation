...
def test(eval_data_loader, model, num_classes,
         output_dir='pred', has_gt=True, save_vis=False, output_ims=False):
    model.eval()
    batch_time = AverageMeter()
    data_time = AverageMeter()
    end = time.time()
...
def parse_args():
    # Training settings
    """python segment.py test -d C:\Users\Josh\Documents\cs444\final_project\datasets\cityscapes\cityscapes -c 19 --arch drn_d_22 --pretrained C:\Users\Josh\Documents\cs444\final_project\drn_d_22_cityscapes.pth --phase test --batch-size 1 --workers=2"""
